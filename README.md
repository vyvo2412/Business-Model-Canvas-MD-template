...
We expect our clients will react favorably by using their preferred method of contact to check in with them, this gesture would show that we care about their business and how our product is integrating and adding value to their organization.</p>
  ...
  <tr>
    ...
    <td>
      ...
      <p align="justify">We will utilize Sales Representatives to manage new and current customer contact. We plan on using the following platforms to attract new customers. Social Media sites such as: "Facebook", "Twitter", "You Tube", "Instagram", "Tumblr" and "Linked In". We feel Web Advertising through Google could broaden our clients, initially we would limit our clicks to 50 a day and evaluating if more or less is beneficial. For managers that are not as tech savvy, we will use the old tried and true methods; phone calls, e-mails, website and the very important face-to-face contacts. 
We plan to peak and keep our client's interest in our product by allowing them to use and evaluate our basic customizable program free for 120 days. Afterwards, we will have several purchase options to include; an annual, 2 years or 3 years subscriptions. Subscription purchases, will be through our website or over the phone. Cost will be based on the clients number of employees and years subscribed. Support will be provided via our website, phone calls, on-line chat/video and in person if needed.</p>
    </td>
  </tr>
  <tr>
    <td colspan="3">
